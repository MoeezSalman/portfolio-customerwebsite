...
const d = {
  ...
  // --- feedback wall ---
  feedbackEyebrow: { en: "Happy clients", ar: "عملاء سعداء" },
  feedbackTitle: { en: "What people say", ar: "ماذا يقول الناس" },
  feedbackLead: {
    en: "Real words from real floors. Add yours — it takes twenty seconds.",
    ar: "كلمات حقيقية عن أرضيات حقيقية. أضف رأيك — لا يستغرق سوى عشرين ثانية.",
  },
  feedbackFormTitle: { en: "Leave your feedback", ar: "اترك رأيك" },
  feedbackFormLead: { en: "Tell others how your floor turned out.", ar: "أخبر الآخرين كيف صارت أرضيتك." },
  feedbackRating: { en: "Your rating", ar: "تقييمك" },
  feedbackMessage: { en: "Your message", ar: "رسالتك" },
  feedbackMessagePlaceholder: {
    en: "How did the floor turn out?",
    ar: "كيف صارت الأرضية؟",
  },
  feedbackPhone: { en: "Mobile number", ar: "رقم الجوال" },
  feedbackPhoneNote: {
    en: "Shown masked. We only use it to say thank you.",
    ar: "يظهر مخفيًا جزئيًا. نستخدمه فقط لنشكرك.",
  },
  feedbackSubmit: { en: "Post feedback", ar: "انشر رأيك" },
  feedbackSending: { en: "Posting…", ar: "جارٍ النشر…" },
  feedbackThanks: { en: "Thank you! Your feedback is on the wall.", ar: "شكرًا لك! رأيك الآن على الجدار." },
  feedbackTooShort: { en: "Write at least a few words.", ar: "اكتب بضع كلمات على الأقل." },
  feedbackTooMany: { en: "Please wait a minute before posting again.", ar: "يرجى الانتظار دقيقة قبل النشر مجددًا." },
  feedbackNew: { en: "New", ar: "جديد" },
  feedbackYours: { en: "Your feedback", ar: "رأيك" },
  feedbackReviews: { en: "reviews", ar: "تقييمًا" },
  feedbackJustNow: { en: "Just now", ar: "الآن" },
  ratingLabel: { en: "out of 5", ar: "من ٥" },
