...
export const areas: Area[] = [
  { id: "olaya", name: { en: "Olaya", ar: "العليا" }, note: { en: "Head office · Street 13", ar: "المقر الرئيسي · شارع ١٣" }, eta: 15, lat: 24.694, lng: 46.685, tier: "core" },
  { id: "al-yasmin", name: { en: "Al Yasmin", ar: "الياسمين" }, note: { en: "Villas and compounds", ar: "فلل ومجمعات" }, eta: 25, lat: 24.828, lng: 46.649, tier: "core" },
